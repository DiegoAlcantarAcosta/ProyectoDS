...
public class pruebas {
    ...
    public static void main(String[] args) {
        ...
        Contacto contacto = new Contacto("Wili", "wiliberto", "perez", "perez", "1", tipoBanco.BANCOPPEL);
        Contacto contacto1Actua = new Contacto("Wilo", "wiliberto", "perez", "perez", "1", tipoBanco.BANCOPPEL);
        Contacto contacto2 = new Contacto("Mari", "Juna", "perez", "Lopez", "2", tipoBanco.BANCOPPEL);
