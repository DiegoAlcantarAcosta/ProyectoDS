...
public class Transferencia extends javax.swing.JFrame {
    ...
    public Transferencia() {
        ...
        Tarjeta tarjetaDesti = tj.obtenerTarjetaPorNumero(new Tarjeta(tr.getDatos().getContacto().getNumeroCuenta()));
        
        SaldoDisponibleTexxField.setText(tr.getDatos().getTarjeta().getSaldo().toString());
        txtBancoDestinatario.setText(tr.getDatos().getContacto().getBanco().toString());
        txtNombreDestinatario.setText(tarjetaDesti.getPersona().getNombre() + " " + tarjetaDesti.getPersona().getApellidoP());
        txtNumCuentaDest.setText(tarjetaDesti.getNumeroCuenta());
    ...
    String numeroCuentaDestinatario = txtNumCuentaDest.getText();
    String numeroCuentaPropietario = tr.getDatos().getTarjeta().getNumeroCuenta();
    Double importe = Double.parseDouble(txtImporte.getText());
    String motivo = txtMotivo.getText();

    // Crear la entidad Transferenciaa
        entidades.Transferencia transferenciaa = new entidades.Transferencia();
    ...
    if (tr.realizarTransferencia(transferenciaa)) {
        // Transferencia exitosa
        tr.getDatos().setTranferencia(transferenciaa);
        
        TransferenciaConfirmacion t = new TransferenciaConfirmacion();
        t.show();
        dispose();
    } else {
        // Saldo insuficiente
